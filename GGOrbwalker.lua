...
do
    ...
    function Menu:__init()
        ...
        self.Orbwalker.RandomHumanizer:MenuElement({id = 'Min', name = 'Min', value = 100, min = 30, max = 300, step = 10})
        self.Orbwalker.RandomHumanizer:MenuElement({id = 'Max', name = 'Max', value = 150, min = 30, max = 400, step = 10})
        ...
        self.Main:MenuElement({id = 'CursorDelay', name = 'Cursor Delay', value = 0, min = 0, max = 50, step = 1})
